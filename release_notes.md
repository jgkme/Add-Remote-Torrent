...
*   **Build:** Chrome (`add-remote-torrent-v0.4.62.zip` / `.crx`) and Firefox (`*-firefox.zip`) artifacts.
...
*   **Build:** Chrome (`add-remote-torrent-v0.4.59.zip` / `.crx`) and Firefox (`*-firefox.zip`) artifacts.
...
*   **Build:** Chrome (`add-remote-torrent-v0.4.54.zip` / `.crx`) and Firefox (`*-firefox.zip`) artifacts.
